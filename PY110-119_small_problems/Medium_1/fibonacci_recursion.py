...
but it's worth putting in a little time early on to see what recursion looks like.
Recursion can, in some situations, greatly simplify some algorithms.

A recursive function has three primary qualities:

1. It must have a base case.
    - This is a condition that tells the function to stop recursing
    and begin the process of returning to the first call to the function.
    ...
    At this point, we know the answer: sum_recursive(1) == 1. Thus, we can return the value 1.
...
Given this recursive algorithm,
try to write a recursive function that computes the nth Fibonacci number,
