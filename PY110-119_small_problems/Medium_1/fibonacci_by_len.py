...
the index of the first Fibonacci number that has the number of digits specified by the argument.
...
Since Python version 3.10.7,
conversion of large integers to strings with more than 4300 digits raises an error.
This means that the last test case will raise an error.

To bypass this limitation,
we can use set sys.set_int_max_str_digits from the sys module to a new upper limit.
